...
#let diseases = diseases_yaml(yaml("../../config/parameters.yaml"))
#let date = date(yaml("../../config/parameters.yaml"))
...
#conf.header_info_cim("../../assets/logo.png")
...
#conf.signature("../../assets/signature.png", "Dr. Jane Smith, MPH", "Associate Medical Officer of Health")

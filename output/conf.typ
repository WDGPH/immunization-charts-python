...
#let header_info_cim(
  ...
  grid(
    ...
    [#set align(center + bottom)
      #text(size: 17.5pt, fill: fill_colour)[*Request for Vaccination Record*]]
...
#let client_info_tbl_en(
  ...
  let col2_content = align(left)[
    ...
    School: #smallcaps[*#client_data.school*]
  ]
...
// // Define the function that will generate the table
// #let create-vaccine-table(immunizations_due) = {
//   // Get the vaccine data for the specified client ID
//   let due_groups = client_data.at(client_id).vaccines_due.at(0)
  
//   // Create a function to format a list of items
//   let format-list(items) = {
//     if items.len() > 0 {
//       for item in items {
//         - item
//       }
...
//   // Check if group 1 is empty to determine the number of columns
//   if due_groups.group_1.len() == 0 {
//     // Case: No group 1 vaccines, so create a 2-column table
//     table(
//       columns: (1fr, 1fr),
//       stroke: none,
//       align: left,
//       inset: 10pt,
//       [
//         #text(size: 1.2em)[Measles, Mumps, Rubella, Varicella]
//       ],
//       [
//         #text(size: 1.2em)[Meningococcal disease]
//       ],
//       format-list(due_groups.group_2),
//       format-list(due_groups.group_3)
//     )
//   } else {
//     // Case: Group 1 vaccines are present, so create a 3-column table
//     table(
//       columns: (1fr, 1fr, 1fr),
//       stroke: none,
//       align: left,
//       inset: 10pt,
//       [
//         #text(size: 1.2em)[Diphtheria, Pertussis, Tetanus, Polio]
//       ],
//       [
//         #text(size: 1.2em)[Measles, Mumps, Rubella, Varicella]
//       ],
...
//         #text(size: 1.2em)[Meningococcal disease]
//       ],
//       format-list(due_groups.group_1),
//       format-list(due_groups.group_2),
//       format-list(due_groups.group_3)
//     )
//   }
